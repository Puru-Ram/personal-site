...
const data = [
  {
    ...
    date: '2017-02-01',
    desc: 'Monitored and managed a group of 28 students for the design and fabrication of an 800cc.'
      + '2-seater utility track vehicle specially suitable for desert terrain,'
      + 'for an All India level utility terrain vehicle design and fabrication competition organized by Polaris Motorsports, India.'
      + 'The final three-day event, consisting of Technical Inspection, hill Climb, Suspension, and traction tests,'
      + 'and 4-hour endurance race held at the Thar Desert, in the month of February-2018.',
  },
  {
